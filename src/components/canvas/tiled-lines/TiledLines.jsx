...
import "./TiledLines.scss";

export default function TiledLines() {
  ...
  function downloadCanvasAsPNG() {
    const canvas = document.getElementById("tiled-lines");
    const fileName="tiled-lines.png";
  ...
  function drawLines() {
    ...
    function tiledLines(x, y, width, height, color = "#ffffff", lineWidth = 1) {
  ...
  return (
    <div className="component-view">
      <div ref={canvasContainer} className="tiled-lines-container">
        <canvas ref={canvasRef} id="tiled-lines" width={canvasSize.width} height={canvasSize.height}></canvas>
        <div id="tiled-lines-buttons">
        <button id="tiled-lines-button" type="button" onClick={drawLines}>Generate</button>
        <button id="tiled-lines-button" type="button" onClick={downloadCanvasAsPNG}>Download</button>
        </div>
      </div>
    </div>
  );
